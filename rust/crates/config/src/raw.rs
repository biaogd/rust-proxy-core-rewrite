...
pub(crate) struct RawConfig {
    ...
    pub(crate) tunnels: Option<Vec<Value>>,
...
#[derive(Debug, Default, Deserialize)]
#[serde(rename_all = "kebab-case")]
pub(crate) struct RawTun {
    pub(crate) enable: Option<bool>,
    pub(crate) device: Option<String>,
    pub(crate) stack: Option<String>,
    pub(crate) dns_hijack: Option<Vec<String>>,
    pub(crate) auto_route: Option<bool>,
    pub(crate) auto_detect_interface: Option<bool>,
    pub(crate) mtu: Option<i64>,
    pub(crate) gso: Option<bool>,
    pub(crate) gso_max_size: Option<i64>,
    pub(crate) inet4_address: Option<Vec<String>>,
    pub(crate) inet6_address: Option<Vec<String>>,
    pub(crate) auto_redirect: Option<bool>,
    pub(crate) auto_redirect_input_mark: Option<i64>,
    pub(crate) auto_redirect_output_mark: Option<i64>,
    pub(crate) strict_route: Option<bool>,
    pub(crate) route_address: Option<Vec<String>>,
    pub(crate) route_address_set: Option<Vec<String>>,
    pub(crate) route_exclude_address: Option<Vec<String>>,
    pub(crate) route_exclude_address_set: Option<Vec<String>>,
    pub(crate) inet4_route_address: Option<Vec<String>>,
    pub(crate) inet6_route_address: Option<Vec<String>>,
    pub(crate) inet4_route_exclude_address: Option<Vec<String>>,
    pub(crate) inet6_route_exclude_address: Option<Vec<String>>,
    pub(crate) include_interface: Option<Vec<String>>,
    pub(crate) exclude_interface: Option<Vec<String>>,
    pub(crate) include_uid: Option<Vec<i64>>,
    pub(crate) include_uid_range: Option<Vec<String>>,
    pub(crate) exclude_uid: Option<Vec<i64>>,
    pub(crate) exclude_uid_range: Option<Vec<String>>,
    pub(crate) exclude_src_port: Option<Vec<i64>>,
    pub(crate) exclude_src_port_range: Option<Vec<String>>,
    pub(crate) exclude_dst_port: Option<Vec<i64>>,
    pub(crate) exclude_dst_port_range: Option<Vec<String>>,
    pub(crate) include_android_user: Option<Vec<i64>>,
    pub(crate) include_package: Option<Vec<String>>,
    pub(crate) exclude_package: Option<Vec<String>>,
    pub(crate) include_mac_address: Option<Vec<String>>,
    pub(crate) exclude_mac_address: Option<Vec<String>>,
    pub(crate) endpoint_independent_nat: Option<bool>,
    pub(crate) udp_timeout: Option<i64>,
    pub(crate) file_descriptor: Option<i64>,
    pub(crate) disable_icmp_forwarding: Option<bool>,
    pub(crate) recvmsgx: Option<bool>,
    pub(crate) sendmsgx: Option<bool>,
    #[serde(flatten)]
    pub(crate) extra: BTreeMap<String, Value>,
}
