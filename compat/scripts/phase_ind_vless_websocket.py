#!/usr/bin/env python3
"""IN-D Go/Rust differential for VLESS WebSocket (WSS) inbound TCP and UDP.
...
Combined ws-path+grpc stays rejected until a shared HTTP mux lands. Half-close
stays on the native TLS IN-D gate.
"""
...
def main() -> int:
    ...
    with tempfile.TemporaryDirectory(prefix="phase-inc-vless-wss-") as temporary:
