...
| Windows amd64 — Phase 5D named pipe | Oracle | Pending | Native GitHub Actions Go/Rust named-pipe auth-bypass and HTTP response differential is configured; no result is claimed before completion |
