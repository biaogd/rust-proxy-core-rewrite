...
| `generate` | Oracle | Partial | Phases 5A6a–5A6e accept UUID v4, Reality/WireGuard X25519, VLESS X25519 and ECH key material; ML-KEM/Sudoku generators remain unclaimed |
