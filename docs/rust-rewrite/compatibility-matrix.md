...
| Darwin arm64 beyond Phase 4F5 | Oracle | Not started | Capability-specific native evidence |
...
| Linux amd64 beyond Phase 4F5 | Oracle | Not started | Later namespace/TUN and capability-specific evidence |
