...
| Shadowsocks (`ss`) | Oracle | **Parity in Phase 6C-B SIP004 AEAD TCP scope** | `phase6c_shadowsocks.py` and `phase6c_shadowsocks_ciphers.py` run Go and Rust through the same official-library SS authority. AES-128-GCM, AES-256-GCM and ChaCha20-IETF-Poly1305 pass domain/IPv4 relay, 128 KiB framing, half-close, MATCH rejection and controller boundaries. Stream/extra/2022 ciphers, UDP, UoT, plugins, providers/groups, server direction and advanced socket/dialer options remain open |
