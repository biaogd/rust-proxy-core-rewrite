...
| Darwin arm64 — Phase 6C-M6 Shadowsocks shadow-tls v3 | Oracle | **Parity in declared scope** | Native hand-rolled v3 client with rustls session-id hook passes Clash `plugin: shadow-tls` config contract and SS2022 TCP domain/large-payload wire comparison against the Go oracle; process survival matches and half-close shares the oracle limitation, 2026-08-29 |
