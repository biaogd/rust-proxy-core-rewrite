...
| Proxy groups/select/fallback/url-test/load-balance | Oracle | Partial | Select/fallback/URL-test retain prior control and health behavior. All three load-balance strategies have REST/control and TCP wire evidence; automatic HTTP health adds startup, eager/lazy interval, timeout, touch activation, configured dial-failure thresholds, refused-connection activation and failover. Authenticated SOCKS5 fallback members additionally pass startup/manual/eager health, refused-connection activation and survivor routing. Exact failure-window boundaries, delayed-handshake success reset, SOCKS5 URL-test/load-balance/error coverage and UDP remain |
