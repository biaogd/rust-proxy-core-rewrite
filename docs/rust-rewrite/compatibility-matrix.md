...
| `convert-ruleset` | Oracle | Partial | Phases 5A5a–5A5b accept IP-CIDR text/YAML ↔ MRS v1 with bidirectional Go/Rust frame interchange and minimal CIDR range decomposition; domain/classical behavior and remaining parser/error classes are unclaimed |
