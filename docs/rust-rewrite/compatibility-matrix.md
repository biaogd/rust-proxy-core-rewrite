...
| ShadowsocksR (`ssr`) | Oracle | Outbound A–D (gaps remain) | TCP origin/auth_aes128_*/auth_sha1_v4/auth_chain_a/b; plain/http_*/tls1.2_ticket_* camouflage/random_head; stream ciphers + none/dummy; UDP outbound skips TCP obfs (Go parity); D stress/negatives/soak. No inbound SSR; mudb multi-user e2e unclaimed |
