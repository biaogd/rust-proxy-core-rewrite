...
| ShadowsocksR (`ssr`) | Oracle | Partial (SSR-C) | TCP origin/auth_aes128_*/auth_sha1_v4/auth_chain_a/b; plain/http_*/tls1.2_ticket_* camouflage/random_head; stream ciphers + none/dummy; UDP outbound vs pinned shadowsocksrr. SSR-D (malformed/stress/soak/three-platform) deferred |
