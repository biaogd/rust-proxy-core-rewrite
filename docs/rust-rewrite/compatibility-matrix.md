...
| Darwin arm64 beyond Phase 5A7a | Oracle | Not started | Capability-specific native evidence |
...
| Linux amd64 beyond Phase 5A7a | Oracle | Not started | Later namespace/TUN and capability-specific evidence |
