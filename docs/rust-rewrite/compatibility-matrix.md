...
| ShadowsocksR (`ssr`) | Oracle | Partial (SSR-B) | TCP origin + auth_aes128_md5/sha1; plain/http_simple/http_post/tls1.2_ticket_* camouflage; aes-128/256-cfb vs pinned shadowsocksrr server. SSR-C (`auth_sha1_v4`, `auth_chain_*`, `random_head`) and UDP deferred |
