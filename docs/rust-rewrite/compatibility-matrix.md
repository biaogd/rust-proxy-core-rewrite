...
| `generate` | Oracle | Partial | Phases 5A6a–5A6d accept UUID v4, Reality/WireGuard X25519 keypairs and VLESS X25519 material; ECH/ML-KEM/Sudoku generators remain unclaimed |
