...
| VLESS | Oracle | **Parity in Phase 6E-A declared native-TCP client scope** | Version-zero request/response framing, canonical and Go-mapped UUIDs, domain/IPv4/IPv6, lazy first-write payload, response addons, provider/group/controller integration, large relay and half-close pass `phase6e_vless_tcp.py`; UDP/packet modes, encryption extensions, TLS/transports, Vision/Reality, mux and server direction remain open |
