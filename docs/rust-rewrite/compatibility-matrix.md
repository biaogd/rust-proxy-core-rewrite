...
| `convert-ruleset` | Oracle | Partial | Phase 5A5a accepts IP-CIDR MRS v1 to canonical text, including Go-produced zstd frames and minimal CIDR range decomposition; text/YAML encoding, domain/classical behavior and remaining malformed-input classes are unclaimed |
