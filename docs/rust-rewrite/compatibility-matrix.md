...
| Source/destination/inbound ports and TCP/UDP network | Oracle | **Partial** | Phase 2 proves pure range/list/reversal/error cases; Phases 5B2d–5B2e prove live mixed-TCP SRC/DST/IN port and TCP/UDP network hit/miss routing; UDP ingress remains pending |
