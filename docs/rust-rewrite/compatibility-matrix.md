...
| ShadowsocksR (`ssr`) | Oracle | Complete (outbound A–D) | TCP origin/auth_aes128_*/auth_sha1_v4/auth_chain_a/b; plain/http_*/tls1.2_ticket_* camouflage/random_head; stream ciphers + none/dummy; UDP outbound; D stress/negatives/soak (`SSR_D_SOAK_SECONDS`, default 45s) vs pinned shadowsocksrr. No inbound SSR; mudb multi-user e2e unclaimed |
