...
| Rules, sub-rules and rule providers | Oracle | Partial | Current rule core plus inline/file/HTTP/HTTPS rule providers, YAML/text/MRS, domain/IP/classical RULE-SET, REST and refresh lifecycle pass; GeoIP/GeoSite breadth, later consumers and named provider download proxies remain |
