...
| Darwin arm64 beyond Phase 5A3a | Oracle | Not started | Capability-specific native evidence |
...
| Linux amd64 beyond Phase 5A3a | Oracle | Not started | Later namespace/TUN and capability-specific evidence |
