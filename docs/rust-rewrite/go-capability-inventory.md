...
| GRP-02 | URL-test, fallback and load-balance strategies | Partial: fallback, URL-test and all three load-balance strategies have configuration/views, real HTTP health/delay, failover and TCP routing evidence | 5C1 scheduling and exhaustive health gates |
