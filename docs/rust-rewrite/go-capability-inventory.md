...
| OUT-15 | SSH: authentication, host-key policy, keepalive and multiplexing | Partial: 6J-A password/public-key TCP + host-key verify + session reuse | UDP, `dialer-proxy`, keepalive identity, host-key-algorithm application and inbound remain |
