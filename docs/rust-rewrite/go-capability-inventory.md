...
| OUT-04 | SOCKS5 proxy client: TCP/UDP, auth and remote/local resolution | Partial: plaintext TCP CONNECT covers no-auth/auth credential boundaries, method/reply lifecycle, retry and domain/IPv4/IPv6 remote addressing | 6B2 TLS, UDP/UoT, overlength credentials and dialer-chain gates |
