...
| OUT-10 | Snell versions, obfs/security extensions, UDP and pool | Partial; 7E-A versions 1–3 TCP outbound | 7E-A: `phase7e_snell_tcp.py` plus `protocol-snell` `tcp_relay`; `udp`/`reuse`/`obfs-opts`/v4/inbound deferred |
