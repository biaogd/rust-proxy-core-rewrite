...
| OUT-14 | WireGuard and AmneziaWG: userspace stacks, peers, routes and DNS | Partial; 6I-A single-peer IPv4 TCP outbound | 6I-A: `phase6i_wireguard_tcp.py` plus `protocol-wireguard` `tcp_relay`; userspace boringtun+smoltcp, no OS TUN; AmneziaWG/peers/IPv6/UDP/remote-DNS/inbound deferred |
