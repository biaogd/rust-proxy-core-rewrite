...
| OUT-05 | Shadowsocks: cipher matrix, plugins, UDP and UoT | Partial: Phase 6C A–J covers eight shared SIP004 AEAD and eight legacy stream ciphers over TCP/native UDP, standard 2022 TCP including AES single-hop EIH, UoT v1/v2, providers and health | 2022 UDP is blocked by an oracle interop panic; Go-only extra ciphers, multi-hop EIH, plugins, IPv6 UDP and server direction remain |
