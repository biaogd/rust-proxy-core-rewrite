...
| OUT-12 | TUIC v4/v5: QUIC, 0-RTT, congestion and UDP relay | Partial; 6H-A/B/C v5 TCP+UDP+lifecycle outbound | 6H-A/B/C: `phase6h_tuic_tcp.py`, `phase6h_tuic_udp.py`, `phase6h_tuic_lifecycle.py`, `phase6h_tuic_soak.py`; v4/0-RTT/inbound deferred; congestion names only |
