...
| GRP-02 | URL-test, fallback and load-balance strategies | Partial: fallback, URL-test and round-robin load-balance configuration/views, real HTTP health/delay, failover and TCP routing | 5C1 scheduling, consistent-hashing/sticky and exhaustive health gates |
