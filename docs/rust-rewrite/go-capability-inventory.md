...
| OUT-21 | Per-proxy dialer-proxy chains and sing-mux | Partial: 7T1-A TCP chains — HTTP/SOCKS5 path-proving slice plus SS/SSR/Snell on the shared dial; VMess/VLESS/Trojan/AnyTLS next; UDP chains and sing-mux remain | 7T1 |
