...
| OUT-14 | WireGuard and AmneziaWG: userspace stacks, peers, routes and DNS | Partial; 6I-A/B single-peer TCP+UDP outbound | 6I-A/B: `phase6i_wireguard_tcp.py` / `phase6i_wireguard_udp.py` plus `protocol-wireguard` `tcp_relay`/`udp_relay`; userspace boringtun+smoltcp, no OS TUN; AmneziaWG/peers/inbound deferred; 6I-C lifecycle next |
