...
| OUT-10 | Snell versions, obfs/security extensions, UDP and pool | Partial; 7E-A/B versions 1–3 TCP + v3 UDP outbound | 7E-A/B: `phase7e_snell_tcp.py` / `phase7e_snell_udp.py` plus `protocol-snell` `tcp_relay`/`udp_relay`; `reuse`/`obfs-opts`/v4/inbound deferred |
