...
| OUT-06 | ShadowsocksR: cipher/protocol/obfs and UDP | Complete outbound A–D: origin + auth_aes128_* + auth_sha1_v4 + auth_chain_a/b ; plain/http_*/tls1.2_ticket_*/random_head; stream ciphers + none/dummy; UDP; D negatives/stress/soak vs pin | 7A–7D done; no inbound; mudb multi-user e2e unclaimed; long soak opt-in |
