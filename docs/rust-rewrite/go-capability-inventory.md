...
| CLI-09 | `generate` subcommand family | Partial: UUID v4 and Reality X25519 keypair generation | Accepted 5A6a–5A6b; remaining keypair and encryption generators remain |
