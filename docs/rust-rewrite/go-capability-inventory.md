...
| OUT-05 | Shadowsocks: cipher matrix, plugins, UDP and UoT | Partial: Phase 6C A–H covers eight shared SIP004 AEAD and eight shared legacy stream ciphers over TCP/native UDP, UoT v1/v2, providers and health | Go-only extra ciphers, plugins, 2022, IPv6 UDP and server direction remain |
