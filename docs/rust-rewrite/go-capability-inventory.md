...
| OUT-16 | Mieru, AnyTLS and Sudoku | Partial: Phase 6G-A/B/C implements Clash `type: anytls` config parse, password auth, native TLS TCP carrier, default padding, session reuse/mux, UDP via UoT v2 and Go/Rust TCP/mux/UDP differentials | idle/heartbeat recovery polish (6G-D), optional Restls/ShadowTLS/JLS carriers (6G-E), plus Mieru/Sudoku remain open |
