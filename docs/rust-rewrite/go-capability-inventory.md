...
| CLI-08 | `convert-ruleset` subcommand and MRS/classical/domain/IP output | Partial: IP-CIDR MRS v1 to canonical text | Accepted 5A5a; other behavior/direction slices remain |
