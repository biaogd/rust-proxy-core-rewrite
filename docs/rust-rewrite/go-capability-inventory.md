...
| RULE-06 | SRC/DST/IN-PORT, NETWORK and DSCP | Partial (default local-TCP DSCP 5B2c) | 5B2 completion |
...
| RULE-12 | PASS, PASS-RULE, REMATCH/REMATCH-NAME and rescan mutation semantics | Partial (pure core plus live PASS/PASS-RULE 5B3e–5B3f) | 5B3 live routing |
