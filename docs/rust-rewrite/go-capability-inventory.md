...
| OUT-06 | ShadowsocksR: cipher/protocol/obfs and UDP | Partial (SSR-C): origin + auth_aes128_* + auth_sha1_v4 + auth_chain_a/b ; plain/http_*/tls1.2_ticket_*/random_head; stream ciphers + none/dummy; UDP vs pin | 7A/7B/7C done; SSR-D (malformed/stress/soak/three-platform) deferred |
