...
| OUT-16 | Mieru, AnyTLS and Sudoku | Partial: Phase 6G-A/B/C/D implements Clash `type: anytls` config parse, password auth, native TLS TCP carrier, default padding, session reuse/mux, UDP via UoT v2, idle janitor/heartbeat/recovery and Go/Rust TCP/mux/UDP/idle differentials | optional Restls/ShadowTLS/JLS carriers (6G-E), plus Mieru/Sudoku remain open |
