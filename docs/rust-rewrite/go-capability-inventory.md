...
| CLI-08 | `convert-ruleset` subcommand and MRS/classical/domain/IP output | Partial: IP-CIDR text/YAML ↔ MRS v1 | Accepted 5A5a–5A5b; domain/classical and broader parser/error slices remain |
