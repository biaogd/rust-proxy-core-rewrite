...
| OUT-06 | ShadowsocksR: cipher/protocol/obfs and UDP | Partial (SSR-B): origin + auth_aes128_* ; plain/http_*/tls1.2_ticket_* camouflage; aes-128/256-cfb TCP vs pin | 7A/7B done; SSR-C/D (auth_sha1_v4, auth_chain_*, random_head, UDP) deferred |
