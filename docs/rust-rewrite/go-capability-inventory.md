...
| OUT-10 | Snell versions, obfs/security extensions, UDP and pool | Partial; 7E-A/B/C versions 1–3 TCP + v3 UDP + simple-obfs outbound | 7E-A/B/C: `phase7e_snell_tcp.py` / `phase7e_snell_udp.py` / `phase7e_snell_obfs.py` plus crate tests; `reuse`/remaining obfs/v4/inbound deferred |
