...
| GRP-02 | URL-test, fallback and load-balance strategies | Partial: fallback plus URL-test configuration/view, real HTTP-member health/delay, fixed persistence, group-delay and TCP routing | 5C1 automatic scheduling, exhaustive health and load-balance gates |
